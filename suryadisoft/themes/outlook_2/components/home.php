      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <? if($top_content->getTitle($n) != "") {?>
          ...
          <td>
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="<?=WebContent::getPropertyValue(WebContent::getPropertyValue("selected_theme") . "_table_header_background")?>">
              <tr> 
                <td><img src="<?=(_URLPATH . "themes/outlook_2/")?>images/<? if (WebContent::getPropertyValue("classic_body_bgcolor") == "" || WebContent::getPropertyValue("classic_body_bgcolor") == "#FFFFFF") {?>tab_corner_left.gif<? } else {?>tab_corner_left_bl.gif<? }?>"></td>
                <td></td>
                <td align="right"><img src="<?=(_URLPATH . "themes/outlook_2/")?>images/<? if (WebContent::getPropertyValue("classic_body_bgcolor") == "" || WebContent::getPropertyValue("classic_body_bgcolor") == "#FFFFFF") {?>tab_corner_right.gif<? } else {?>tab_corner_right_bl.gif<? }?>"></td>
              </tr>
              <tr> 
                <td></td>
                <td> <div align="center" class="tableheaderfont"><strong> 
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr> 
          <td><table width="100%" border="<? if($right_content->getType($n) == "Frame") {?>1<? } else {?>0<? }?>" cellpadding="2" cellspacing="0" bordercolor="<?=WebContent::getPropertyValue(WebContent::getPropertyValue("selected_theme") . "_table_border_color")?>">
              <tr> 
                <td bgcolor="<?=WebContent::getPropertyValue(WebContent::getPropertyValue("selected_theme") . "_table_background")?>"> 
                  <strong> </strong> <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td><strong>
