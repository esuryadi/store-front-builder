...
<tr>
	...
	<tr>
  	<td>
			<table border="0" cellpadding="0" cellspacing="0" bgcolor="<?=WebContent::getPropertyValue(WebContent::getPropertyValue("selected_theme") . "_table_header_background")?>">
      <tr> 
      	<td><img src="<?=(_URLPATH . "themes/cool_3D/")?>images/<?=WebContent::getPropertyValue("selected_color_scheme")?>/3d-tab_corner-tl.gif"></td>
        <td background="<?=(_URLPATH . "themes/cool_3D/")?>images/<?=WebContent::getPropertyValue("selected_color_scheme")?>/3d-tab_top.gif"></td>
        <td><img src="<?=(_URLPATH . "themes/cool_3D/")?>images/<?=WebContent::getPropertyValue("selected_color_scheme")?>/3d-tab_corner-tr.gif"></td>
      </tr>
      <tr> 
      	<td background="<?=(_URLPATH . "themes/cool_3D/")?>images/<?=WebContent::getPropertyValue("selected_color_scheme")?>/3d-tab_side-l.gif"></td>
        <td> 
					<table border="0" cellspacing="0" cellpadding="3">
          <tr> 
          	<td nowrap><div class="tableheaderfont"><strong><?=$top_content->getTitle($n)?></strong></div></td>
          </tr>
          </table>
				</td>
        <td background="<?=(_URLPATH . "themes/cool_3D/")?>images/<?=WebContent::getPropertyValue("selected_color_scheme")?>/3d-tab_side-r.gif"></td>
      </tr>
      </table>
		</td>
	</tr>
	...
	<tr>
		<td>
			<table width="100%" border="<? if($top_content->getType($n) == "Frame") {?>1<? } else {?>0<? }?>" cellpadding="2" cellspacing="0" bordercolor="<?=WebContent::getPropertyValue(WebContent::getPropertyValue("selected_theme") . "_table_border_color")?>">
			<tr>
...
<? $position = "left";?>
    ...
    <tr>
        ...
        <tr> 
          ...
          <td> 
						<table border="0" cellspacing="0" cellpadding="3">
            <tr> 
            	<td nowrap><div class="tableheaderfont"><strong><?=$left_content->getTitle($n)?></strong></div></td>
            </tr>
            </table>
					</td>
          <td background="<?=(_URLPATH . "themes/cool_3D/")?>images/<?=WebContent::getPropertyValue("selected_color_scheme")?>/3d-tab_side-r.gif"></td>
    ...
    <tr>
    	<td>
				<table width="100%" border="<? if($left_content->getType($n) == "Frame") {?>1<? } else {?>0<? }?>" cellpadding="2" cellspacing="0" bordercolor="<?=WebContent::getPropertyValue(WebContent::getPropertyValue("selected_theme") . "_table_border_color")?>">
				<tr>
					<td bgcolor="<?=WebContent::getPropertyValue(WebContent::getPropertyValue("selected_theme") . "_table_background")?>">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
      ...
      <td>
        ...
        <tr> 
          ...
          <td> 
						<table border="0" cellspacing="0" cellpadding="3">
            <tr> 
            	<td nowrap><div class="tableheaderfont"><strong><?=$middle_content->getTitle($n)?></strong></div></td>
            </tr>
           	</table>
					</td>
          <td background="<?=(_URLPATH . "themes/cool_3D/")?>images/<?=WebContent::getPropertyValue("selected_color_scheme")?>/3d-tab_side-r.gif"></td>
		...
		<tr> 
    	<td>
				<table width="100%" border="<? if($middle_content->getType($n) == "Frame") {?>1<? } else {?>0<? }?>" cellpadding="2" cellspacing="0" bordercolor="<?=WebContent::getPropertyValue(WebContent::getPropertyValue("selected_theme") . "_table_border_color")?>">
				<tr>
					<td bgcolor="<?=WebContent::getPropertyValue(WebContent::getPropertyValue("selected_theme") . "_table_background")?>">
        		<table width="100%" border="0" cellspacing="0" cellpadding="0">
          	<tr>
...
<td valign="top"> 
    ...
    <tr>
        ...
        <tr> 
          ...
          <td> 
						<table border="0" cellspacing="0" cellpadding="3">
            <tr> 
            	<td nowrap> <div class="tableheaderfont"><strong><?=$right_content->getTitle($n)?></strong></div></td>
            </tr>
            </table>
					</td>
          <td background="<?=(_URLPATH . "themes/cool_3D/")?>images/<?=WebContent::getPropertyValue("selected_color_scheme")?>/3d-tab_side-r.gif"></td>
    ...
    <tr>
    	<td>
				<table width="100%" border="<? if($right_content->getType($n) == "Frame") {?>1<? } else {?>0<? }?>" cellpadding="2" cellspacing="0" bordercolor="<?=WebContent::getPropertyValue(WebContent::getPropertyValue("selected_theme") . "_table_border_color")?>">
				<tr>
					<td bgcolor="<?=WebContent::getPropertyValue(WebContent::getPropertyValue("selected_theme") . "_table_background")?>">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
...
<td valign="top" colspan="3">       
		...
		<td>
			...
			<tr> 
				...
				<td> 
					<table border="0" cellspacing="0" cellpadding="3">
					<tr> 
						<td nowrap> <div class="tableheaderfont"><strong><?=$bottom_content->getTitle($n)?></strong></div></td>
					</tr>
					</table>
				</td>
				<td background="<?=(_URLPATH . "themes/cool_3D/")?>images/<?=WebContent::getPropertyValue("selected_color_scheme")?>/3d-tab_side-r.gif"></td>
	...
	<tr>
		<td>
			<table width="100%" border="<? if($bottom_content->getType($n) == "Frame") {?>1<? } else {?>0<? }?>" cellpadding="2" cellspacing="0" bordercolor="<?=WebContent::getPropertyValue(WebContent::getPropertyValue("selected_theme") . "_table_border_color")?>">
			<tr>
				<td bgcolor="<?=WebContent::getPropertyValue(WebContent::getPropertyValue("selected_theme") . "_table_background")?>">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
