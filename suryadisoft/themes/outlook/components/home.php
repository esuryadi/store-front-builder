    ...
    <td valign="top" colspan="3">       
      ...
      <table width="100%" border="<? if($top_content->getType($n) == "Frame") {?>1<? } else {?>0<? }?>" cellpadding="2" cellspacing="0" bordercolor="<?=WebContent::getPropertyValue(WebContent::getPropertyValue("selected_theme") . "_table_border_color")?>">
				...
				<tr>
					<td bgcolor="<?=WebContent::getPropertyValue(WebContent::getPropertyValue("selected_theme") . "_table_header_background")?>">
		...
		<td valign="top"> 		
			...
			if ($left_content->getFilename($n) == "login.php") {
				...
				<? $title = urlencode($left_content->getTitle($n));?>
					<tr>
						<td bgcolor="<?=WebContent::getPropertyValue(WebContent::getPropertyValue("selected_theme") . "_table_header_background")?>"><div align="center" class="tableheaderfont"><strong><?=$left_content->getTitle($n)?></strong></div></td>
					</tr>
				<? }?>
				<tr>
					<td bgcolor="<?=WebContent::getPropertyValue(WebContent::getPropertyValue("selected_theme") . "_table_background")?>">
