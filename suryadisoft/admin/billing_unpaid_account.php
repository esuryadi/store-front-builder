...
$query = "SELECT * FROM BILLING, BILLING_RECORD WHERE BILLING.user_id = BILLING_RECORD.user_id AND BILLING_RECORD.status = 'unpaid'";
...
while ($rs = mysql_fetch_array($query_result)) {
	...
	$pfpro["DESC"] = "SuryadiSoft Online Store Subscription Monthly Fee. Question about this charge? Call 405-823-7864";
	...
	if ($transaction["RESULT"] == 0) {
		...
		$admin->updateBillingRecord($rs["id"],"paid");
	} else {
